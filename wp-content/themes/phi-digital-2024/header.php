...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$phi_digital_2024_description = get_bloginfo( 'description', 'display' );
			if ( $phi_digital_2024_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $phi_digital_2024_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
